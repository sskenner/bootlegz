...
bootlegz, a Netflix clone, is a production quality web application of non-trivial size and complexity built as a project for a web development bootcamp. All features and functionality coded by yours truly.  The app is currently depolyed (and most likely sleeping) on heroku.
